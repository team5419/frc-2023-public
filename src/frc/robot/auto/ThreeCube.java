...
public class ThreeCube extends SequentialCommandGroup { // basic routine for diff drive
    ...
    public ThreeCube(Swerve drivetrain, Vision vision, Coner coneShooter, Cuber cubeShooter, Lights lights, boolean balance, boolean red) {
        ...
        addCommands(
            ...
            new AutoGetCube(drivetrain, cubeShooter, coneShooter, vision, new Translation2d(2.5, 1.14), new Translation2d(shootX, 1.7), -1, lights, false),
            Commands.runOnce(() -> 
            ...
            if(balance) {
                addCommands(
                    new AutoGetCube(drivetrain, cubeShooter, coneShooter, vision, new Translation2d(2.3, 2.1), new Translation2d(shootX, 1.87), -1, lights, false),
