...
public class ConeDoubleCube extends SequentialCommandGroup { // basic routine for diff drive
    ...
    public ConeDoubleCube(Swerve drivetrain, Vision vision, Coner coneShooter, Cuber cubeShooter, Lights lights, boolean shootHigh, boolean cableSide) {
        ...
        if(cableSide) {
            addCommands(
                ...
                new RamseteSwerve(drivetrain, vision, new Pose2d(new Translation2d(1.0, y(0.2)), _180), new RamseteOptions(true, false, false, 10.0, -1, -1.0, 0.0, true)),
                // we slow down going over the bump (note that maxSpeed has changed from -1.0, which signals to use the default max, to 1.5)
                new RamseteSwerve(drivetrain, vision, new Pose2d(new Translation2d(2.6, y(0.4)), _180), new RamseteOptions(true, false, false, 10.0, -1, 1.5, 0.0, true))
            );
        }
        addCommands(    
            Commands.runOnce(() -> {
            ...
            new RamseteSwerve(drivetrain, vision, new Pose2d(new Translation2d(4.7, y(0.6)), _180), new RamseteOptions(true, false, false, 2.0, -1, -1.0, 0.0)),
            Commands.runOnce(() -> {
            ...
            new RamseteSwerve(drivetrain, vision, new Pose2d(new Translation2d(1.0, y(0.4)), new Rotation2d(0.0)), new RamseteOptions(true, false, false, 10.0, -1, -1.0, 0.0)),
        ...
        if(cableSide) {
            addCommands(
                ...
                new RamseteSwerve(drivetrain, vision, new Pose2d(new Translation2d(1.25, y(-0.3)), Rotation2d.fromDegrees(0.0)), new RamseteOptions(true, false, false, 10.0, -1, -1.0, 0.0, true)),
                // drive slowly while going over the bump
                new RamseteSwerve(drivetrain, vision, new Pose2d(new Translation2d(2.5, y(-0.3)), Rotation2d.fromDegrees(0.0)), new RamseteOptions(true, false, false, 10.0, -1, 2.0, 0.0, true))
            );
        }
        addCommands(    
            // drive fast until we're past the charge station, and turn 60 degrees so we're facing the right direction for intake
            new RamseteSwerve(drivetrain, vision, new Pose2d(new Translation2d(3.5, y(-0.3)), Rotation2d.fromDegrees(-60.0)), new RamseteOptions(true, false, false, 6.0, -1, -1.0, 0.0, true)),
            Commands.runOnce(() -> {
            ...
            new RamseteSwerve(drivetrain, vision, new Pose2d(new Translation2d(5.3, y(0.25)), Rotation2d.fromDegrees(-60.0)), new RamseteOptions(true, false, false, 6.0, -1, -1.0, 0.0, false)),
            // drive diagonally forward through the second cube to pick it up
            new RamseteSwerve(drivetrain, vision, new Pose2d(new Translation2d(4.75, y(1.1)), Rotation2d.fromDegrees(-60.0)), new RamseteOptions(true, false, false, 10.0, -1, -1.0, 0.0, true)),
            Commands.runOnce(() -> {
            ...
            new RamseteSwerve(drivetrain, vision, new Pose2d(new Translation2d(2.5, y(1.6)), Rotation2d.fromDegrees(0.0)), new RamseteOptions(true, false, false, 6.0, -1, -1.0, 0.0, true)),
